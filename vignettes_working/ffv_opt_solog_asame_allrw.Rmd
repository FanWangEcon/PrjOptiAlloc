---
title: LOG-LINEAR--DRS (Log-Linear) Optimal Allocation Analytical Common Alpha
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{LOG-LINEAR--DRS (Log-Linear) Optimal Allocation Analytical Common Alpha}
