...
for (it_rho_ctr in seq(1,length(ar_rho))) {
  ...
  # Need to be very careful about keys/identifier, so that the same children are linked about. Should use merge.
  ...
  mt_opti_N[, it_rho_ctr] = ar_opti
  # mt_opti_H[, it_rho_ctr] = ar_pred
