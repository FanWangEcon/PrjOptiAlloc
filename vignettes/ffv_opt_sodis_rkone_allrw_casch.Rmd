...
fl_teacher_increase_percent = 0.10
```
...
# Construct Increment Specific Effect of Each Additional Teacher and Generate Optimal Target Queue
...
# Optimal Targeting
dfca_exmain_target <- dfca_exmain %>% ungroup(id) %>% select(IDil, A_il, alpha_il, beta_i)
