...
The [Guatemala and Cebu dataset](https://www.sciencedirect.com/science/article/pii/S1570677X16300107) jitter/rand version, select cebu only between 0 and 24. Generates four categories based on initial height and mother education levels. Regress height on protein inputs allowing for heterogeneous effecst for each of the four categories.

This is the 2nd file in the structure below:

1. R: [Function](https://fanwangecon.github.io/PrjOptiAlloc/reference/ffy_opt_dtgch_cbem4.html)
2. Rmd: [Function Line by Line Save](https://fanwangecon.github.io/REconTools/articles/ffv_opt_dtgch_cbem4.html)
3. rda: [Data File Generated](https://github.com/FanWangEcon/REconTools/blob/master/data/df_opt_dtgch_cbem4.rda)
4. R: [Data File Description](https://fanwangecon.github.io/PrjOptiAlloc/reference/ffd_opt_dtgch_cbem4.html))   
