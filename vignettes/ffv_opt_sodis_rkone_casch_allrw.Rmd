...
5. $V^{Q}_{il}$: value given optimal choices at queue point
...
ffi_solve_queue_alloc <- function(ar_rho,
    ...
    # Step 5
    # merge in value for rho, planner inequality aversion
    df_alloc_i_long <- df_alloc_i_long %>%
